...
('c1c1c1c1-c1c1-c1c1-c1c1-c1c1c1c1c1c1', 'John', 'Smith', 'john.smith@email.com', '$2a$10$XQKmBvCQPGxJkE.jP5nVbOqC5p6FQ9UqPqH7yqJ3p1rKKKqVqPJWO', '+1555123456', 'traveler', 'https://i.pravatar.cc/300?img=15', 'Adventure seeker and photography enthusiast', '{"street": "123 Main St", "city": "New York", "state": "NY", "country": "USA", "zipCode": "10001"}', '{"newsletter": true, "notifications": true, "currency": "USD", "language": "en"}', true, true, false, NOW() - INTERVAL '3 hours', NOW() - INTERVAL '1 year', NOW()),
...
-- Paris images
('d1d1d1d1-1111-1111-1111-111111111111', 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34', 'Eiffel Tower at sunset', true, 0, NOW(), NOW()),
('d1d1d1d1-1111-1111-1111-111111111111', 'https://images.unsplash.com/photo-1499856871958-5b9627545d1a', 'Louvre Museum', false, 1, NOW(), NOW()),
('d1d1d1d1-1111-1111-1111-111111111111', 'https://images.unsplash.com/photo-1511739001486-6bfe10ce785f', 'Seine River cruise', false, 2, NOW(), NOW()),
-- Tokyo images
('d2d2d2d2-2222-2222-2222-222222222222', 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf', 'Tokyo cityscape at night', true, 0, NOW(), NOW()),
('d2d2d2d2-2222-2222-2222-222222222222', 'https://images.unsplash.com/photo-1528164344705-47542687000d', 'Traditional temple', false, 1, NOW(), NOW()),
('d2d2d2d2-2222-2222-2222-222222222222', 'https://images.unsplash.com/photo-1542051841857-5f90071e7989', 'Mount Fuji view', false, 2, NOW(), NOW()),
-- Swiss Alps images
...
-- Confirmed bookings
('b1b1b1b1-b1b1-b1b1-b1b1-b1b1b1b1b1b1', 'PT202410001', 'c1c1c1c1-c1c1-c1c1-c1c1-c1c1c1c1c1c1', 'd1d1d1d1-1111-1111-1111-111111111111', '2025-12-15', '2025-12-19', 2, 0, 0, 2, 2598.00, 259.80, 519.60, 2338.20, 'USD', 'confirmed', 'success', 'credit_card', 'WELCOME20', 'Room with Eiffel Tower view please', '{"leadGuest": {"name": "John Smith", "email": "john.smith@email.com", "phone": "+1555123456"}}', NOW() - INTERVAL '45 days', NOW()),
('b2b2b2b2-b2b2-b2b2-b2b2-b2b2b2b2b2b2', 'PT202410002', 'c2c2c2c2-c2c2-c2c2-c2c2-c2c2c2c2c2c2', 'd4d4d4d4-4444-4444-4444-444444444444', '2025-11-20', '2025-11-27', 1, 0, 0, 1, 1699.00, 169.90, 0.00, 1868.90, 'USD', 'confirmed', 'success', 'paypal', NULL, 'Vegetarian meals please', '{"leadGuest": {"name": "Emily Davis", "email": "emily.davis@email.com", "phone": "+1555234567"}}', NOW() - INTERVAL '30 days', NOW()),
('b3b3b3b3-b3b3-b3b3-b3b3-b3b3b3b3b3b3', 'PT202410003', 'c3c3c3c3-c3c3-c3c3-c3c3-c3c3c3c3c3c3', 'd3d3d3d3-3333-3333-3333-333333333333', '2026-01-10', '2026-01-16', 2, 0, 0, 2, 4998.00, 499.80, 0.00, 5497.80, 'USD', 'confirmed', 'success', 'credit_card', NULL, 'First time trekking, need equipment advice', '{"leadGuest": {"name": "David Martinez", "email": "david.martinez@email.com", "phone": "+1555345678"}}', NOW() - INTERVAL '20 days', NOW()),

-- Pending booking
('b4b4b4b4-b4b4-b4b4-b4b4-b4b4b4b4b4b4', 'PT202410004', 'c4c4c4c4-c4c4-c4c4-c4c4-c4c4c4c4c4c4', 'd2d2d2d2-2222-2222-2222-222222222222', '2026-02-15', '2026-02-20', 2, 1, 0, 3, 5697.00, 569.70, 0.00, 6266.70, 'USD', 'pending', 'pending', NULL, NULL, 'Child is 10 years old', '{"leadGuest": {"name": "Lisa Anderson", "email": "lisa.anderson@email.com", "phone": "+1555456789"}}', NOW() - INTERVAL '2 days', NOW()),
...
-- Successful payments
('faa1faa1-faa1-faa1-faa1-faa1faa1faa1', 'b1b1b1b1-b1b1-b1b1-b1b1-b1b1b1b1b1b1', 'c1c1c1c1-c1c1-c1c1-c1c1-c1c1c1c1c1c1', 'TXN20241001001', 2338.20, 'USD', 'success', 'credit_card', 'stripe', 'ch_3PqRsT4u5v6w7x8y9z', '{"status": "succeeded", "brand": "visa", "last4": "4242"}', NOW() - INTERVAL '45 days', NOW()),
('faa2faa2-faa2-faa2-faa2-faa2faa2faa2', 'b2b2b2b2-b2b2-b2b2-b2b2-b2b2b2b2b2b2', 'c2c2c2c2-c2c2-c2c2-c2c2-c2c2c2c2c2c2', 'TXN20241001002', 1868.90, 'USD', 'success', 'paypal', 'paypal', 'PAYID-M123ABC456DEF789', '{"status": "COMPLETED", "email": "emily.davis@email.com"}', NOW() - INTERVAL '30 days', NOW()),
('faa3faa3-faa3-faa3-faa3-faa3faa3faa3', 'b3b3b3b3-b3b3-b3b3-b3b3-b3b3b3b3b3b3', 'c3c3c3c3-c3c3-c3c3-c3c3-c3c3c3c3c3c3', 'TXN20241001003', 5497.80, 'USD', 'success', 'credit_card', 'stripe', 'ch_3PqRsT4u5v6w7x8y9a', '{"status": "succeeded", "brand": "mastercard", "last4": "5555"}', NOW() - INTERVAL '20 days', NOW()),
