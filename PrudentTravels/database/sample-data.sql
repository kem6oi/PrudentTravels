...
('a1a1a1a1-a1a1-41a1-91a1-a1a1a1a1a1a1', 'Admin', 'User', 'admin@prudenttravels.com', '$2a$10$XQKmBvCQPGxJkE.jP5nVbOqC5p6FQ9UqPqH7yqJ3p1rKKKqVqPJWO', '+1234567890', 'admin', 'https://i.pravatar.cc/300?img=1', 'System administrator with full access to all features', true, true, false, NOW() - INTERVAL '1 hour', NOW() - INTERVAL '6 months', NOW())
...
-- Support Staff
INSERT INTO "Users" (id, "firstName", "lastName", email, password, phone, role, avatar, bio, "emailVerified", "isActive", "isSuspended", "lastLogin", "createdAt", "updatedAt") VALUES
('b2b2b2b2-b2b2-42b2-92b2-b2b2b2b2b2b2', 'Sarah', 'Johnson', 'sarah.support@prudenttravels.com', '$2a$10$XQKmBvCQPGxJkE.jP5nVbOqC5p6FQ9UqPqH7yqJ3p1rKKKqVqPJWO', '+1234567891', 'support', 'https://i.pravatar.cc/300?img=5', 'Customer support specialist helping travelers worldwide', true, true, false, NOW() - INTERVAL '2 hours', NOW() - INTERVAL '5 months', NOW()),
('b3b3b3b3-b3b3-43b3-93b3-b3b3b3b3b3b3', 'Michael', 'Chen', 'michael.support@prudenttravels.com', '$2a$10$XQKmBvCQPGxJkE.jP5nVbOqC5p6FQ9UqPqH7yqJ3p1rKKKqVqPJWO', '+1234567892', 'support', 'https://i.pravatar.cc/300?img=12', 'Dedicated to providing excellent customer service', true, true, false, NOW() - INTERVAL '30 minutes', NOW() - INTERVAL '4 months', NOW())
ON CONFLICT (email) DO UPDATE SET
    "firstName" = EXCLUDED."firstName",
    "lastName" = EXCLUDED."lastName",
    phone = EXCLUDED.phone,
...
-- Successful payments
('faa1faa1-faa1-4aa1-8aa1-faa1faa1faa1', 'b1b1b1b1-b1b1-41b1-81b1-b1b1b1b1b1b1', 'c1c1c1c1-c1c1-41c1-81c1-c1c1c1c1c1c1', 'TXN20241001001', 2338.20, 'USD', 'success', 'credit_card', 'stripe', 'ch_3PqRsT4u5v6w7x8y9z', '{"status": "succeeded", "brand": "visa", "last4": "4242"}', NOW() - INTERVAL '45 days', NOW()),
('faa2faa2-faa2-4aa2-8aa2-faa2faa2faa2', 'b2b2b2b2-b2b2-42b2-92b2-b2b2b2b2b2b2', 'c2c2c2c2-c2c2-42c2-82c2-c2c2c2c2c2c2', 'TXN20241001002', 1868.90, 'USD', 'success', 'paypal', 'paypal', 'PAYID-M123ABC456DEF789', '{"status": "COMPLETED", "email": "emily.davis@email.com"}', NOW() - INTERVAL '30 days', NOW()),
('faa3faa3-faa3-4aa3-8aa3-faa3faa3faa3', 'b3b3b3b3-b3b3-43b3-93b3-b3b3b3b3b3b3', 'c3c3c3c3-c3c3-43c3-83c3-c3c3c3c3c3c3', 'TXN20241001003', 5497.80, 'USD', 'success', 'credit_card', 'stripe', 'ch_3PqRsT4u5v6w7x8y9a', '{"status": "succeeded", "brand": "mastercard", "last4": "5555"}', NOW() - INTERVAL '20 days', NOW()),
('faa5faa5-faa5-4aa5-8aa5-faa5faa5faa5', 'b5b5b5b5-b5b5-45b5-85b5-b5b5b5b5b5b5', 'c5c5c5c5-c5c5-45c5-85c5-c5c5c5c5c5c5', 'TXN20240901001', 7697.80, 'USD', 'success', 'credit_card', 'stripe', 'ch_3PqRsT4u5v6w7x8y9b', '{"status": "succeeded", "brand": "amex", "last4": "1111"}', NOW() - INTERVAL '90 days', NOW()),

-- Refunded payment
('faa6faa6-faa6-4aa6-8aa6-faa6faa6faa6', 'b6b6b6b6-b6b6-46b6-86b6-b6b6b6b6b6b6', 'c1c1c1c1-c1c1-41c1-81c1-c1c1c1c1c1c1', 'TXN20241001004', 6157.80, 'USD', 'refunded', 'credit_card', 'stripe', 'ch_3PqRsT4u5v6w7x8y9c', '{"status": "refunded", "brand": "visa", "last4": "4242"}', NOW() - INTERVAL '15 days', NOW())
